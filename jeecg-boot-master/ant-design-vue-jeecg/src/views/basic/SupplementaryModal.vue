        ...
        <a-row>
          ...
          <a-col :md="12" :sm="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="代码">
              <a-input placeholder="后台自动生成代码" v-decorator="[ 'code', validatorRules.code]" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row>
...
<script>
  ...
  import {addSupplementary,editSupplementary,duplicateCheck } from '@/api/api'
  export default {
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(!this.model.id){
              obj=addSupplementary(formData);
            }else{
              obj=editSupplementary(formData);
            }
            obj.then((res)=>{
              if(res.success){
