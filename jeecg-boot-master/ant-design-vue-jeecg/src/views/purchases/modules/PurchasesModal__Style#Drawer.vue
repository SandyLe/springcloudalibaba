    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="业务时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择业务时间" v-decorator="[ 'businessDate', validatorRules.businessDate]" :trigger-change="true" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/purchases/purchases/add",
          edit: "/purchases/purchases/edit",
        }
