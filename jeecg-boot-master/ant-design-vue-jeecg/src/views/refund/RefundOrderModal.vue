        ...
        <a-row>
          <a-col :md="12" :sm="12">
            <a-form-item label="原单编号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="[ 'sourceCode', validatorRules.sourceCode]" type="hidden" placeholder="请输入原单编号" />
              <a-input v-decorator="[ 'sourceId', {}]" placeholder="收款单ID" type="hidden" />
              <a-input v-decorator="[ 'sourceBillId', {}]" placeholder="原销售单ID" type="hidden" />
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="12">
            <a-form-item
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        record.sourceBillCode = this.saleOrder.code;
        record.sourceBillType = this.saleOrder.billType;
