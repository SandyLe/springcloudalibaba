...
<script>
  ...
  import {addSaleOrderExpense,editSaleOrderExpense,getExpenseList,duplicateCheck } from '@/api/api'

  export default {
    name: "SaleOrderExpenseModal",
    props: {
      saleOrder: {
        type: Object,
        default: () => {}
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            if(!this.model.id){
              obj=addSaleOrderExpense(formData);
            }else{
              obj=editSaleOrderExpense(formData);
            }
            obj.then((res)=>{
              if(res.success){
