  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        vendorId:{},
        businessTime:{rules: [{ required: true, message: '请输入业务时间!' }]},
        amount:{},
        sort:{},
        states:{},
        },
        url: {
          add: "/purchasereturn/purchasereturn/add",
          edit: "/purchasereturn/purchasereturn/edit",
        }
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'vendorId','businessTime','amount','updateTime','createTime','sort','states'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'vendorId','businessTime','amount','updateTime','createTime','sort','states'))
      },
