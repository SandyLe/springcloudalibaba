package org.jeecg.modules.alibaba;
...
public class AliSignUtil {
    ...
    private static String callApi(URL url, Map<String, String> params) throws IOException {
        String query = buildQuery(params, Constants.CHARSET_UTF8);
        byte[] content = {};
        if (query != null) {
            content = query.getBytes(Constants.CHARSET_UTF8);
        }
        ...
        try {
            ...
            conn.setRequestProperty("Content-Type", "application/x-www-form-urlencoded;charset=" + Constants.CHARSET_UTF8);
