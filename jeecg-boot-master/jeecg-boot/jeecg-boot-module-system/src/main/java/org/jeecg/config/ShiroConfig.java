...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		// 配置不会被拦截的链接 顺序判断
		filterChainDefinitionMap.put("/slTrade/getList", "anon");
		filterChainDefinitionMap.put("/sys/getCheckCode", "anon"); //登录验证码接口排除
		filterChainDefinitionMap.put("/sys/autoLogin", "anon"); //自动登录接口排除
		...
		filterChainDefinitionMap.put("/sys/common/sysdownload/**", "anon");//系统文件下载不限制token
