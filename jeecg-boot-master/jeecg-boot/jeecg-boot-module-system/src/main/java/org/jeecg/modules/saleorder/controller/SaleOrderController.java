...
public class SaleOrderController {
    ...
    public Result<?> edit(@RequestBody DeliveryEditDto deliveryEditDto) throws Exception {
        ...
        // 销售出库
        InventoryOut inventoryOut = new InventoryOut(saleOrder.getId(), BillType.STOCKING.getId(), BillType.SALEORDER.getId(), saleOrder.getWarehouseId(), saleOrder.getDeliveryTime(), BillStatus.TOSEND.getId());
