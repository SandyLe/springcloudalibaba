...
public class StockingServiceImpl extends ServiceImpl<StockingMapper, Stocking>  implements StockingService {
    ...
    public String handleStocking(String id) {
        ...
        InventoryLog inventoryLog = new InventoryLog(id, BillType.STOCKING.getId(), stocking.getMtlId(), stocking.getWarehouseId(), stocking.getStockAmount(), BigDecimal.ZERO, stocking.getBeforeAmount(), stocking.getUnitId(), InventoryOperation.STOCKING.getId());
